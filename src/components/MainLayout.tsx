    ...
    <div className="flex h-screen bg-[#050505] text-foreground transition-colors duration-500 overflow-hidden font-sans selection:bg-blue-500/30">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative bg-black">
        ...
        <div className="flex-1 flex overflow-hidden relative">
          ...
          <main className="flex-1 overflow-y-auto no-scrollbar relative bg-[#050505]">
            ...
            <div className="p-6 lg:p-8 max-w-[2400px] mx-auto relative z-10">
              <motion.div
                key={activeModule}
          ...
          <AnimatePresence>
            {isActivityFeedOpen && (
              <motion.aside
                ...
                className="absolute right-0 top-0 bottom-0 w-[360px] bg-[#0A0A0A] border-l border-white/5 shadow-2xl z-50 flex flex-col backdrop-blur-3xl"
              >
