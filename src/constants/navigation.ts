...
export const ATOMIC_NAVIGATION: NavCategory[] = [
  ...
  },
  {
    ...
    pages: [
      { id: 'p15', label: 'Product Grid', featureIds: ['1', '3', '4'], description: '4-col virtualised grid, elastic search, quick view', path: 'pos/grid' },
      { id: 'p16', label: 'Scanner & Cart', featureIds: ['2', '9'], description: 'Scanner integration, cart editing', path: 'pos/cart' },
      { id: 'p17', label: 'IMEI Validation', featureIds: ['5', '6'], description: 'Real-time chip, duplicate check', path: 'pos/imei' },
      { id: 'p18', label: 'Product Bundling', featureIds: ['7'], description: 'Bundle builder, partial return', path: 'pos/bundles' },
      { id: 'p19', label: 'Serial Tracking', featureIds: ['8'], description: 'Accessories, power banks', path: 'pos/serial' },
      { id: 'p20', label: 'Customer Lookup', featureIds: ['10', '52', '53', '54', '55', '56', '58', '59'], description: 'Customer search, creation, edit, merge, blacklist, birthday reminder', path: 'pos/customers' },
      { id: 'p21', label: 'Tax & Rounding', featureIds: ['11', '26'], description: 'VAT config, rounding to 5 fils', path: 'pos/tax' },
      { id: 'p22', label: 'Split Payments', featureIds: ['12'], description: 'Payment matrix (cash, card, BNPL, loyalty)', path: 'pos/payments' },
      { id: 'p23', label: 'Discounts', featureIds: ['13', '27', '206'], description: 'Discount input, price override (with PIN), capping', path: 'pos/discounts' },
      { id: 'p24', label: 'Loyalty & Gifts', featureIds: ['14', '23'], description: 'Points redemption, gift card sale/redemption', path: 'pos/loyalty' },
      { id: 'p25', label: 'Receipts', featureIds: ['15', '16', '48', '220'], description: 'Thermal, email, re-print, custom layout', path: 'pos/receipts' },
      { id: 'p26', label: 'Hold & Exchange', featureIds: ['17', '18', '21'], description: 'Hold, retrieve, exchange item', path: 'pos/exchange' },
      { id: 'p27', label: 'Layaway & Notes', featureIds: ['19', '22'], description: 'Deposit plan, sale notes', path: 'pos/layaway' },
      { id: 'p28', label: 'Offline Sync', featureIds: ['31', '32', '33'], description: 'Offline queue, sync engine, storage', path: 'pos/sync' },
    ]
  },
  {
    id: 'repairs',
